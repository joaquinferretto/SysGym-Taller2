...
namespace exxen2._0.capaVisual.Administrador
{
    partial class GestionPlanesFormulario
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelEncabezado.BackColor = Color.FromArgb(79, 70, 229); panelEncabezado.Dock = DockStyle.Top; panelEncabezado.Height = 56; panelEncabezado.Controls.Add(lblTitulo); panelEncabezado.Controls.Add(lblDescripcion); panelEncabezado.Controls.Add(btnVolver);
            lblTitulo.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right; lblTitulo.AutoSize = false; lblTitulo.Font = new Font("Segoe UI", 16F, FontStyle.Bold); lblTitulo.ForeColor = Color.White; lblTitulo.Location = new Point(22, 8); lblTitulo.Size = new Size(880, 40); lblTitulo.Text = "Planes | Gestión de planes y precios"; lblTitulo.TextAlign = ContentAlignment.MiddleLeft;
            ...
            splitContenido.Dock = DockStyle.Fill; splitContenido.Size = new Size(1068, 480); splitContenido.FixedPanel = FixedPanel.None; splitContenido.IsSplitterFixed = false; splitContenido.MinimumSize = new Size(900, 420); splitContenido.Panel1MinSize = 400; splitContenido.Panel2MinSize = 400; splitContenido.SplitterWidth = 6; splitContenido.Panel1.BackColor = Color.FromArgb(248, 250, 252); splitContenido.Panel1.Padding = new Padding(16); splitContenido.Panel2.BackColor = Color.FromArgb(248, 250, 252); splitContenido.Panel2.Padding = new Padding(0, 16, 16, 16);
