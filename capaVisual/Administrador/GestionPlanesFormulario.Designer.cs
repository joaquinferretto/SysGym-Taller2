...
namespace exxen2._0.capaVisual.Administrador
{
    partial class GestionPlanesFormulario
    {
        ...
        private void InitializeComponent()
        {
            ...
            splitContenido.Dock = DockStyle.Fill; splitContenido.FixedPanel = FixedPanel.None; splitContenido.IsSplitterFixed = false; splitContenido.Panel1MinSize = 400; splitContenido.Panel2MinSize = 400; splitContenido.SplitterWidth = 6; splitContenido.Panel1.BackColor = Color.FromArgb(248, 250, 252); splitContenido.Panel1.Padding = new Padding(16); splitContenido.Panel2.BackColor = Color.FromArgb(248, 250, 252); splitContenido.Panel2.Padding = new Padding(0, 16, 16, 16);
