...
namespace exxen2._0.capaVisual.Compartido
{
    partial class GestionEjerciciosFormulario
    {
        ...
        private void InitializeComponent()
        {
            ...
            splitContenido.Dock = DockStyle.Fill; splitContenido.FixedPanel = FixedPanel.None; splitContenido.IsSplitterFixed = false; splitContenido.MinimumSize = new Size(900, 420); splitContenido.SplitterWidth = 6; splitContenido.Panel1MinSize = 420; splitContenido.Panel2MinSize = 340;
            ...
            tablaFicha.ColumnCount = 2; tablaFicha.Dock = DockStyle.Fill; tablaFicha.Padding = new Padding(0, 8, 0, 0); tablaFicha.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 110F)); tablaFicha.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F)); tablaFicha.RowCount = 3; tablaFicha.RowStyles.Add(new RowStyle(SizeType.Absolute, 34F)); tablaFicha.RowStyles.Add(new RowStyle(SizeType.Percent, 100F)); tablaFicha.RowStyles.Add(new RowStyle(SizeType.Absolute, 34F));
