...
namespace exxen2._0.capaVisual.Entrenador
{
    partial class RutinasEntrenadorFormulario
    {
        ...
        private void InitializeComponent()
        {
            ...
            barraAcciones = new Panel(); nuevaRutina = new Button(); guardarRutina = new Button(); actualizar = new Button(); agregarEjercicio = new Button(); actualizarEjercicio = new Button(); darDeBaja = new Button(); reactivar = new Button(); quitarEjercicio = new Button(); lblEstado = new Label();
            panelContenido = new Panel(); layoutContenido = new TableLayoutPanel(); panelFormulario = new Panel(); layoutDetalle = new TableLayoutPanel(); contenedorFormulario = new TableLayoutPanel();
            ...
            ((ISupportInitialize)(tabla)).BeginInit(); ((ISupportInitialize)(tablaEjercicios)).BeginInit(); panelEncabezado.SuspendLayout(); barraAcciones.SuspendLayout(); panelContenido.SuspendLayout(); layoutContenido.SuspendLayout(); panelFormulario.SuspendLayout(); layoutDetalle.SuspendLayout(); contenedorFormulario.SuspendLayout(); SuspendLayout();
            ...
            ConfigurarBoton(actualizarEjercicio, "Actualizar ejercicio", new Point(516, 8), new Size(132, 34), Color.FromArgb(226, 232, 240), Color.FromArgb(30, 41, 59), 4, actualizarEjercicio_Click);
            ConfigurarBoton(darDeBaja, "Dar de baja", new Point(656, 8), new Size(112, 34), Color.FromArgb(254, 242, 242), Color.FromArgb(185, 28, 28), 5, darDeBaja_Click);
            ConfigurarBoton(reactivar, "Reactivar", new Point(776, 8), new Size(112, 34), Color.FromArgb(220, 252, 231), Color.FromArgb(22, 101, 52), 6, reactivar_Click);
            ConfigurarBoton(quitarEjercicio, "Quitar ejercicio", new Point(896, 8), new Size(132, 34), Color.FromArgb(254, 242, 242), Color.FromArgb(185, 28, 28), 7, quitarEjercicio_Click);
            darDeBaja.Visible = false; reactivar.Visible = false;
            ...
            layoutContenido.Dock = DockStyle.Fill; layoutContenido.ColumnCount = 1; layoutContenido.RowCount = 2; layoutContenido.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F)); layoutContenido.RowStyles.Add(new RowStyle(SizeType.Percent, 38F)); layoutContenido.RowStyles.Add(new RowStyle(SizeType.Percent, 62F)); layoutContenido.Controls.Add(tabla, 0, 0); layoutContenido.Controls.Add(panelFormulario, 0, 1);

            ConfigurarTabla(tabla); tabla.ColumnHeadersHeight = 34; tabla.TabIndex = 1; tabla.SelectionChanged += new System.EventHandler(tabla_SelectionChanged); tabla.Columns.AddRange(new DataGridViewColumn[] { colId, colRutina, colCreador, colAsignados, colCreacion, colEstado });
            colId.Name = "colId"; colId.Visible = false; colRutina.HeaderText = "Rutina"; colRutina.Name = "colRutina"; colRutina.FillWeight = 30; colRutina.MinimumWidth = 120; colCreador.HeaderText = "Entrenador"; colCreador.Name = "colCreador"; colCreador.FillWeight = 24; colCreador.MinimumWidth = 110; colAsignados.HeaderText = "Socios asignados"; colAsignados.Name = "colAsignados"; colAsignados.FillWeight = 17; colAsignados.MinimumWidth = 100; colCreacion.HeaderText = "Creacion"; colCreacion.Name = "colCreacion"; colCreacion.FillWeight = 14; colCreacion.MinimumWidth = 90; colEstado.HeaderText = "Estado"; colEstado.Name = "colEstado"; colEstado.FillWeight = 15; colEstado.MinimumWidth = 80;
            ...
            panelFormulario.BackColor = Color.White; panelFormulario.BorderStyle = BorderStyle.FixedSingle; panelFormulario.Padding = new Padding(12); panelFormulario.Dock = DockStyle.Fill; panelFormulario.Controls.Add(layoutDetalle);
            layoutDetalle.Dock = DockStyle.Fill; layoutDetalle.ColumnCount = 1; layoutDetalle.RowCount = 2; layoutDetalle.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F)); layoutDetalle.RowStyles.Add(new RowStyle(SizeType.Percent, 55F)); layoutDetalle.RowStyles.Add(new RowStyle(SizeType.Percent, 45F)); layoutDetalle.Controls.Add(tablaEjercicios, 0, 0); layoutDetalle.Controls.Add(contenedorFormulario, 0, 1);
            ...
            series.KeyPress += new KeyPressEventHandler(series_KeyPress); repeticiones.KeyPress += new KeyPressEventHandler(repeticiones_KeyPress); peso.KeyPress += new KeyPressEventHandler(peso_KeyPress); descanso.KeyPress += new KeyPressEventHandler(descanso_KeyPress); orden.KeyPress += new KeyPressEventHandler(orden_KeyPress);
