...
namespace exxen2._0.capaVisual.Entrenador
{
    ...
    public partial class RutinasEntrenadorForm : Form
    {
        ...
        public RutinasEntrenadorForm() : this(new UsuarioSistema { Nombre = "Entrenador", Apellido = "de diseno" })
        {
        }
        ...
        private void membresia_Format(object sender, ListControlConvertEventArgs e)
        {
        ...
        private void guardarRutina_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (idRutina == 0)
                {
                    ...
                    FormularioVisualHelper.MostrarExito(lblEstado, "Plantilla creada. Ahora podes agregarle ejercicios y asignarla a socios.");
                }
                else
                {
                    rutinas.Modificar(rutina);
                    FormularioVisualHelper.MostrarExito(lblEstado, "Plantilla actualizada.");
                }
        ...
        private void agregarEjercicio_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormularioVisualHelper.MostrarExito(lblEstado, "Ejercicio agregado a la plantilla.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void asignar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                FormularioVisualHelper.MostrarExito(lblEstado, "Rutina asignada al socio. La misma plantilla puede asignarse a otros socios.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void darDeBaja_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormularioVisualHelper.MostrarExito(lblEstado, "Plantilla dada de baja y asignaciones finalizadas.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void RutinasEntrenadorForm_Load(object sender, EventArgs e)
        {
