    ...
    public partial class GestionPlanesForm : Form
    {
        ...
        private void guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Plan creado correctamente.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void actualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Plan actualizado correctamente.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void darDeBaja_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Plan dado de baja.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void reactivar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Plan reactivado correctamente.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void GestionPlanesForm_Load(object sender, EventArgs e)
        {
        ...
        {
            FormularioVisualHelper.ValidarEntradaDecimal(precio, e);
        }
    }
}
