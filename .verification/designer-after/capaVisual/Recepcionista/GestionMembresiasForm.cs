...
namespace exxen2._0.capaVisual.Recepcionista
{
    ...
    public partial class GestionMembresiasForm : Form
    {
        ...
        public GestionMembresiasForm() : this(new UsuarioSistema { Nombre = "Recepcionista", Apellido = "de diseno" })
        {
        }

        /* Inicializa los componentes existentes y las dependencias de la pantalla sin consultar la base de datos. */
        public GestionMembresiasForm(UsuarioSistema usuario) : this(usuario, Color.FromArgb(5, 150, 105))
        {
        }
        ...
        private void crear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Membresia creada y primera cuota generada.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void actualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Membresia actualizada.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void habilitar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Membresia habilitada.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void deshabilitar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Cargar();
                nuevo_Click(null, EventArgs.Empty);
                FormularioVisualHelper.MostrarExito(lblEstado, "Membresia deshabilitada.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void generarCuota_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormularioVisualHelper.MostrarExito(lblEstado, "Nueva cuota generada.");
            }
            catch (Exception ex)
            {
                FormularioVisualHelper.MostrarError(lblEstado, ex);
        ...
        private void GestionMembresiasForm_Load(object sender, EventArgs e)
        {
